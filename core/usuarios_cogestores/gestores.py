...
def gestores_crear_vista(usuario_rol_gestor_id):
    '''
...
def gestores_actualizar_vista(usuario_rol_gestor_id, gestor_id):
    '''
...
def gestores_eliminar_vista(usuario_rol_gestor_id, gestor_id):
    try:
